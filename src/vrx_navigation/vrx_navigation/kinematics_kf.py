...
from geometry_msgs.msg import Point, Quaternion, Twist, Vector3Stamped,PointStamped
...
class kalman_filter(Node):
    ...
    def register_sensors(self, imu_measurements, gnss_measurements, uwb_measurements):
        ...
        for i in range(len(self.uwb_measurements)):
            ...
            self.uwb_subscribers.append(self.create_subscription(PointStamped, self.uwb_measurements[i].topic_name, self.uwb_measurements[i].callback, 10))
