...
from vrx_navigation.register_sensor import imu, gnss, uwb
from vrx_navigation.kinematics_kf import kalman_filter
import numpy as np
import rclpy
import time
...
def main(args=None):
    ...
    sbg = imu('sbg', '/wamv/sensors/imu/imu/data', 'ENU')
    ...
    gps = gnss('ublox_gps', '/wamv/sensors/gps/gps/fix')
    ## UWB objects
    #uwb_sensor = uwb('uwb', '/uwb/loc')
    uwb_sensor = uwb('uwb', '/makara_00/uwb_01')
